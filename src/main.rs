...
#[command(
    version,
    about = "Standalone local Rust, TypeScript, JavaScript, Python, C#, Go, and Java code retrieval over MCP (Java: syntax indexing and retrieval only; the other six additionally support optional language-server navigation)"
)]
struct Cli {
