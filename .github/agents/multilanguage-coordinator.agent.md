...
Rust, TypeScript, TSX, JavaScript, JSX, and Python syntax retrieval are already supported. Add any future language sequentially through the language-adapter contract. Add its optional language-server adapter only after syntax, persistence, and retrieval acceptance passes.
